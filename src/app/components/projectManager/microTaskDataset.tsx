  ...
  useEffect(() => {
    const fetchAnnotations = async () => {
      ...
      try {
        ...
        // Approve dialog offers only positive-sentiment annotations; the negatives
        // are covered by the separate rejection-reason list in the Reject flow.
        setAnnotations(
          (response.data.data || []).filter(
            (a: { sentiment?: string }) => a.sentiment === "positive",
          ),
        );
      } catch (error) {
